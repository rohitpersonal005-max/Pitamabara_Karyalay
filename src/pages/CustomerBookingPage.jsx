        ...
        <div className="relative bg-white px-8 py-16 sm:p-20 overflow-hidden text-center border-b border-slate-100 rounded-t-[2.5rem]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight mb-6 drop-shadow-sm leading-normal py-2 sm:whitespace-nowrap">
              <span className="inline-block pl-2 pr-0 py-2 italic font-serif text-transparent bg-clip-text bg-gradient-to-r from-rose-600 via-orange-600 to-amber-500 mr-1">{t("shriPitambara")}</span>
              <span className="inline-block pl-2.5 pr-0 py-2 italic font-serif text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-yellow-500">{t("jyotishKaryalaya")}</span>
            </h1>
